local jobmenu = {
  ...
  menu = {
    ...
    font = 0,
    ["main"] = {
      title = "Choise your job", -- ENGLISH : Choise your job
      name = "main",
      buttons = {
        {title = "Minor", name = "Mineur", id = 3}, -- ENGLISH : Minor
        {title = "Fisherman", name = "Pêcheur", id = 14}, -- ENGLISH : Fisherman
        {title = "Taxi Driver", name = "Taxi", id = 15}, -- ENGLISH : Taxi Driver
