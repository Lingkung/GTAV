...
RegisterServerEvent('esx_jk_jobs:setJoblum')
AddEventHandler('esx_jk_jobs:setJoblum', function(job)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_jk_jobs:setJobtai')
AddEventHandler('esx_jk_jobs:setJobtai', function(job)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	xPlayer.setJob("lumberjack", 0) -- 0 is job grade
	TriggerClientEvent('esx:showNotification', source, 'You were hired ~g~' .. xPlayer.getName())	
...
RegisterServerEvent('esx_jk_jobs:setJobno')
AddEventHandler('esx_jk_jobs:setJobno', function(job)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	xPlayer.setJob("lumberjack", 0) -- 0 is job grade
	TriggerClientEvent('esx:showNotification', source, 'You were hired ~g~' .. xPlayer.getName())	
