...
Config.WeedPrice = 12	-- sell price for single, not pooch (black money)
Config.MethPrice = 18	-- sell price for single, not pooch (black money)
Config.CokePrice = 22	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 20	-- sell price for single, not pooch (black money)
