...
BGCanvas.style.backgroundImage = "url('https://pbs.twimg.com/profile_images/850613412921036801/B4vEdwk3.jpg')";
const setUp = (function(){
  const cardPicLoc = "./Images/Cards/";
  const picLoc = "./Images/MiscImages/";
  const cardImgMap = new Map();
  const miscImgMap = new Map();
  const pics = ['RedFeltTable.png','GoldCoin.png','FrameNarrow.png','bitcoin.png','CardBack.png','player.png','banker.png','tie.png','he.png','RedChip.png','BlueChip.png','BlackChip.png','DragonLeft.png','DragonRight.png'];
